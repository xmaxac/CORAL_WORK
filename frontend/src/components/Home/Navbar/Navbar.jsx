  ...
  return (
    <div>
      ...
      <nav className='relative flex items-center h-[70px] p-6 bg-white border-b border-slate-200'>
        <h1 className='absolute left-[2%] text-3xl select-none text-blue-500 hover:cursor-pointer' onClick={()=>navigate("/")} style={{fontFamily: 'gothamBold'}}>CoralBase</h1>
        <ul className='absolute left-[17%] flex space-x-6 items-center text-gray-600' style={{fontFamily: 'gothamLight'}}>
          <li className='flex items-center justify-center transition-transform duration-300 ease-in-out hover:translate-y-[-0.3rem] hover:cursor-pointer select-none text-blue-500'>
            <HomeIcon className='w-[15px] mr-1'/>
            Home
          </li>
          <li className='flex items-center justify-center transition-transform duration-300 ease-in-out hover:translate-y-[-0.3rem] hover:cursor-pointer select-none'>
