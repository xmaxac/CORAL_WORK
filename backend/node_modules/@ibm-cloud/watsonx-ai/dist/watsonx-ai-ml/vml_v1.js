...
class WatsonxAiMlVml_v1 extends ibm_cloud_sdk_core_1.BaseService {
    ...
    listPrompts(params) {
        ...
        const parameters = {
            ...
            defaultOptions: Object.assign(Object.assign({}, this.baseOptions), { serviceUrl: this.wxServiceUrl.split('/wx')[0], headers: Object.assign(Object.assign(Object.assign({}, sdkHeaders), { 'Accept': 'application/json', 'Content-Type': 'application/json' }), _params.headers), axiosOptions: {
                    signal: _params.signal,
                } }),
        };
        return this.createRequest(parameters);
